...
import he.pract.anothermaximumproblem.Main.InputReader;
import he.pract.anothermaximumproblem.Main.Task;
...
public class TestMain {
    ...
    final String dir = System.getProperty("user.dir")+"/src/"+"he/pract/anothermaximumproblem/";
    ...
    public void verifyOut()throws Exception{
        ...
        OutputStream outputStream = new FileOutputStream(dir+"testout.txt");
        PrintWriter testOut = new PrintWriter(outputStream);
        ...
        try{
            ...
            while(
                ...
                if((solved = solvedReader.readLine()) !=null && solved.length()>0){
                    if(!expected.equals(solved)){
                        testOut.println("test case "+testcase+" "+expected+"==="+ solved);
                    }
